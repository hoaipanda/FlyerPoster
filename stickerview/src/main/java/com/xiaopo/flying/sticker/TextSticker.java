...
//        matrix.postScale(getScale(), getScale());
    ...
    @NonNull
    public TextSticker setShadow(@NonNull float radius, String color) {

        textPaint.setShadowLayer(
                radius, // radius
                5.0f, // dx
                5.0f, // dy
                Color.parseColor(color) // shadow color
        );
        shadow = radius;
        return this;
    }
    ...
    @NonNull
    public TextSticker setLetterSpacing(@Nullable float spacing) {
